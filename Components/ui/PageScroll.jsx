...
const PlacesScroll = () => {
  return (
    ...
    {/* Gradient Overlay */}
    <div className="absolute inset-0 bg-gradient-to-r  from-[#D1B49D] via-[#F1E2C6] to-[#C4A79C]  pointer-events-none"></div>
        ...
        {companies.map((company, index) => (
          ...
          >
            <motion.img
              src={company.imgSrc}
              alt={company.name}
              className="w-44 h-44 object-cover rounded-lg mx-4"
              whileHover={{
                rotate: [0, 10, -10, 0],
