...
const Footer = () => {
  return (
    <footer className="bg-[#190000] text-creamy-beige mb-0">
        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 grid grid-cols-2 gap-8 xl:mt-0 xl:col-span-2">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h4 className="text-lg leading-6 font-medium text-creamy-beige">Company</h4>
              ...
              <div>
                <h4 className="text-lg leading-6 font-medium text-creamy-beige">Resources</h4>
                <ul className="mt-4 space-y-4">
                  <li>
            ...
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h4 className="text-lg leading-6 font-medium text-creamy-beige">Connect</h4>
                <ul className="mt-4 space-y-4">
                  <li>
